...
**If you find TaoSync useful, please star the repository. Thank you!** [GitHub](https://github.com/ojbkxc/RustSync) [Gitee](https://gitee.com/dr34m/taosync) [Docker Hub](https://hub.docker.com/r/dr34m/tao-sync)
...
To try a development build, look for the latest tag containing `dev` or `pre` on [Docker Hub](https://hub.docker.com/r/dr34m/tao-sync) or [Releases](https://github.com/ojbkxc/RustSync/releases), such as `v0.1.0-dev-build0`. Development builds may contain obvious errors or serious bugs and are not recommended for beginners.
