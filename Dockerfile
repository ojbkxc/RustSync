...
LABEL org.opencontainers.image.description="Rust 重写版多平台自动化存储同步服务"
LABEL org.opencontainers.image.source="https://github.com/ojbkxc/RustSync"
LABEL org.opencontainers.image.licenses="MIT"

VOLUME /app/data
WORKDIR /app
COPY --from=server-builder /app/target/release/rustsync-server /app/rustsync-server
COPY --from=server-builder /app/locales ./locales
...
HEALTHCHECK --interval=30s --timeout=10s --retries=3 \
    CMD wget -q --spider http://localhost:8023/ || exit 1
